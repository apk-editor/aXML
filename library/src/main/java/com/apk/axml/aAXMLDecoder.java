 ...
 */
public class aAXMLDecoder {

	private static File mXMLFile = null;
	private static PrintStream mPrintStream = System.out;

	public aAXMLDecoder(File binaryXML) {
		mXMLFile = binaryXML;
	}

	@TargetApi(Build.VERSION_CODES.KITKAT)
	public String decode() {
		try(FileInputStream inputStream = new FileInputStream(mXMLFile)) {
